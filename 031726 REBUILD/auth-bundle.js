(() => {
  ...
  var init_firebase = __esm({
    "src/firebase.js"() {
      ...
      init_index_esm5();
      firebaseConfig = {
        apiKey: "AIzaSyA1TI2VGXWiL-1DQN6iAety57OEzQcaCwM",
  ...
  // src/react-shim.js
  var ReactRef, useState, useEffect, react_shim_default;
  var init_react_shim = __esm({
    "src/react-shim.js"() {
      ReactRef = typeof window !== "undefined" ? window.React : null;
      if (!ReactRef) {
        throw new Error("React global not found. Ensure React is loaded before auth-bundle.js.");
      }
      useState = ReactRef.useState;
      useEffect = ReactRef.useEffect;
      react_shim_default = ReactRef;
    }
  });
  ...
  function Login() {
    ...
    return react_shim_default.createElement(
      ...
      react_shim_default.createElement(
        "div",
        { style: top },
        react_shim_default.createElement("img", {
          src: "./AXIS_Branding_DarkMode_Outlined.svg",
          alt: "AXIS",
          style: { width: "min(220px, 62vw)", height: "auto", display: "block" }
        })
      ),
      react_shim_default.createElement(
        "div",
        ...
        react_shim_default.createElement(
          ...
          react_shim_default.createElement(
            ...
            react_shim_default.createElement("input", {
              type: "email",
              placeholder: "Email",
              autoComplete: "email",
              value: email,
            ...
            mode === "signup" && react_shim_default.createElement("input", {
              type: "password",
            ...
            error && react_shim_default.createElement(
              "div",
              {
                style: {
                  color: "#ff6b6b",
  ...
  // src/auth-entry.js
  var require_auth_entry = __commonJS({
    "src/auth-entry.js"() {
      init_index_esm5();
      init_App();
      init_firebase();
